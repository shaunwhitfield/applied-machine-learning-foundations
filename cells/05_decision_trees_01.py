"""
05_decision_trees_01.py

Cell 67 of section "Decision Trees" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/05_decision_trees_01.py
...
dt_pipe.fit(X_train, y_train)
print('r2 (max_depth=1):', dt_pipe.score(X_test, y_test.to_numpy()[:, 0]))
