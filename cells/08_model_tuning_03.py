"""
08_model_tuning_03.py

Cell 125-126 of section "Tuning Linear Regression" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/08_model_tuning_03.py
...
print('r2:', rr_pipe.score(X_test, y_test.to_numpy()[:, 0]))
