"""
00_exploring_the_data_05.py

Cell 8 of section "Exploring the Data" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/00_exploring_the_data_05.py
