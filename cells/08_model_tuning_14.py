"""
08_model_tuning_14.py

Cell 152-153 of section "Tuning CatBoost" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/08_model_tuning_14.py
...
# ---- train/test split (X excludes price, as in the notebook) ----
...
# plot a validation curve tracking mse as max_depth increases
