"""
08_model_tuning_11.py

Cell 142 of section "Tuning Decision Trees" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/08_model_tuning_11.py
...
print('r2:', dt_pipe.score(X_test, y_test.to_numpy()[:, 0]))
