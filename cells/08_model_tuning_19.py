"""
08_model_tuning_19.py

Cell 167 of section "Grid Search" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/08_model_tuning_19.py
...
print('r2 (best params):', dt_pipe.score(X_test, y_test.to_numpy()[:, 0]))
