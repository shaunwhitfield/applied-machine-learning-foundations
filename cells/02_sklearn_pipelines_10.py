"""
02_sklearn_pipelines_10.py

Cell 31 of section "Sklearn Pipelines" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/02_sklearn_pipelines_10.py
...
print_df(zip_adder.fit_transform(raw.select(['zipcode', 'price'])))
