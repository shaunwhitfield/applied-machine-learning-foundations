"""
08_model_tuning_08.py

Cell 138-139 of section "Tuning Decision Trees" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/08_model_tuning_08.py
...
# plot a validation curve tracking mse as the max_depth of the
