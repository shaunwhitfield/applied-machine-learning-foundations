"""
00_exploring_the_data_07.py

Cell 10 of section "Exploring the Data" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/00_exploring_the_data_07.py
...
save_chart(raw.sort('price').plot.scatter(x='long', y='lat', alpha=0.5, c='price', s=1),
          '00_exploring_the_data_07')
