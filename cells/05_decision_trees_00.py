"""
05_decision_trees_00.py

Cell 66 of section "Decision Trees" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/05_decision_trees_00.py
...
print('r2 (default):', dt_pipe.score(X_test, y_test.to_numpy()[:, 0]))
