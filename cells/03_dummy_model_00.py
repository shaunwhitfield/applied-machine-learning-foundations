"""
03_dummy_model_00.py

Cell 54 of section "Dummy Model" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/03_dummy_model_00.py
...
# ---- dummy model (baseline: predicts the training mean) ----
...
print('r2:', dummy_pipe.score(X_test, y_test.to_numpy()[:, 0]))
