"""
02_sklearn_pipelines_12.py

Cell 33 of section "Sklearn Pipelines" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/02_sklearn_pipelines_12.py
