"""
09_model_deployment_00.py

Cell 181 of section "End to end notebook" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/09_model_deployment_00.py
...
print('r2:', lr_pipe.score(X_test, y_test.to_numpy()[:, 0]))
