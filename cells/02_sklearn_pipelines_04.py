"""
02_sklearn_pipelines_04.py

Cell 25 of section "Sklearn Pipelines" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/02_sklearn_pipelines_04.py
...
# NOTE: the notebook's global polars output setting doesn't support sparse
# arrays, so this exploratory cell keeps the default (scipy sparse) output
