"""
08_model_tuning_12.py

Cell 143 of section "Tuning Decision Trees" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/08_model_tuning_12.py
...
print('rmse:', mean_squared_error(y_test.to_numpy()[:, 0], dt_pipe.predict(X_test), squared=False))
