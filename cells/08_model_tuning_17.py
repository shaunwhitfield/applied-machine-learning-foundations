"""
08_model_tuning_17.py

Cell 165 of section "Grid Search" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/08_model_tuning_17.py
...
print(f'grid search complete: {len(grid_search.cv_results_["params"])} combinations evaluated')
