"""
08_model_tuning_10.py

Cell 141 of section "Tuning Decision Trees" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/08_model_tuning_10.py
...
# ---- CatBoost has issues with Polars input, so convert to pandas first ----
...
print('rmse:', mean_squared_error(y_test.to_numpy()[:, 0], dt8_pipe.predict(X_test), squared=False))
