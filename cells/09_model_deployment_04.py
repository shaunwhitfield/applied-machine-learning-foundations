"""
09_model_deployment_04.py

Cell 193 of section "Using MLFlow" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/09_model_deployment_04.py
...
# !tree  (IPython shell magic) -- use find instead on macOS
if os.path.exists('mlruns'):
    subprocess.run(['find', 'mlruns', '-maxdepth', '4'])
else:
    print('mlruns/ does not exist yet. Run 09_model_deployment_02.py first to log a model.')
