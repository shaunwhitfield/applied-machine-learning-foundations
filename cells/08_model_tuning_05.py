"""
08_model_tuning_05.py

Cell 129-130 of section "Tuning Linear Regression" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/08_model_tuning_05.py
...
# Our best score is at 0 (which is normal Linear Regression)
alpha = pl.DataFrame({'val': param_range,
                      'scores': scores})
save_chart(alpha.plot(x='val', y='scores'), '08_model_tuning_05')
