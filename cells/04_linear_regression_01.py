"""
04_linear_regression_01.py

Cell 62 of section "Linear Regression" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/04_linear_regression_01.py
...
print_df(lr_pipe.predict(X_test))
