"""
02_sklearn_pipelines_11.py

Cell 32 of section "Sklearn Pipelines" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/02_sklearn_pipelines_11.py
...
print(pipe)
print_df(pipe.fit_transform(raw, raw.select('price')))
