"""
00_exploring_the_data_04.py

Cell 7 of section "Exploring the Data" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/00_exploring_the_data_04.py
...
save_chart(raw.plot.scatter('sqft_living', 'price', alpha=0.1), '00_exploring_the_data_04')
