"""
02_sklearn_pipelines_09.py

Cell 30 of section "Sklearn Pipelines" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/02_sklearn_pipelines_09.py
...
print_df(ct.fit_transform(
    tweak_housing(raw)
    .select([*numeric_features, *categorical_features])
))
