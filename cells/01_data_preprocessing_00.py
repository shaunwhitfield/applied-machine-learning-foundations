"""
01_data_preprocessing_00.py

Cell 15 of section "Data Preprocessing" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/01_data_preprocessing_00.py
