"""
03_dummy_model_02.py

Cell 56 of section "Dummy Model" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/03_dummy_model_02.py
...
print_df(dummy_pipe.predict(X_test))
