"""
02_sklearn_pipelines_07.py

Cell 28 of section "Sklearn Pipelines" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/02_sklearn_pipelines_07.py
...
print_df(cat_pipeline.fit_transform(
    tweak_housing(raw)
    .select(cat_features)
))
