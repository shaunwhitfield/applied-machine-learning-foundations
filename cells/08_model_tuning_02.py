"""
08_model_tuning_02.py

Cell 124 of section "Tuning Linear Regression" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/08_model_tuning_02.py
