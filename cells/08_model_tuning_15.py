"""
08_model_tuning_15.py

Cell 154 of section "Tuning CatBoost" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/08_model_tuning_15.py
...
print('r2:', cr2_4.score(X_test.to_pandas(), y_test.to_numpy()))
