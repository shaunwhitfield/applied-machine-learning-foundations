...
Cell 107 of section "Residuals Plot" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/07_evaluation_07.py
...
save_chart(residuals_plot(cat_pipe, X_train, y_train, X_test, y_test),
          '07_evaluation_07')
