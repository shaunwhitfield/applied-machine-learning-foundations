"""
08_model_tuning_20.py

Cell 168 of section "Grid Search" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/08_model_tuning_20.py
...
print('r2 (default, random_state=42):', dt_pipe.score(X_test, y_test.to_numpy()[:, 0]))
