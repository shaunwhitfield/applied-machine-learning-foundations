"""
08_model_tuning_04.py

Cell 128 of section "Tuning Linear Regression" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/08_model_tuning_04.py
