"""
00_exploring_the_data_03.py

Cell 6 of section "Exploring the Data" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/00_exploring_the_data_03.py
...
# In the notebook this is shown as a heatmap; here we print the table.
corr = (raw
