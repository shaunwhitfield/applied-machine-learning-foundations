...
Cell 108 of section "Residuals Plot" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/07_evaluation_08.py
...
save_chart(residuals_plot(dt_pipe, X_train, y_train, X_test, y_test),
          '07_evaluation_08')
