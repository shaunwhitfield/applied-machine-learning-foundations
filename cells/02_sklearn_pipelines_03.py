"""
02_sklearn_pipelines_03.py

Cell 24 of section "Sklearn Pipelines" from ml-foundations.ipynb, runnable on its own
from the terminal:

    .venv/bin/python cells/02_sklearn_pipelines_03.py
...
print_df(num_pipeline.fit_transform(
    tweak_housing(raw)
